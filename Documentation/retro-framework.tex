...
\usetikzlibrary{arrows,quotes,shapes,shapes.geometric,shapes.gates.logic.US,automata,calc,positioning}
...
\mainmatter
\part{Architecture}
\include{./TeX_files/clockccu}
\part{Components}
\include{./TeX_files/hyperram}
\backmatter
